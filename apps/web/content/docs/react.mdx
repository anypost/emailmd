...
| `lint` | `boolean` | `false` | Run [`lint()`](/docs/api-reference#lintmarkdown-options) alongside each render; findings land in `lintFindings`. |
...
| `lint` | `boolean` | `false` | Run [`lint()`](/docs/api-reference#lintmarkdown-options) on each render and surface findings in the warnings banner |
